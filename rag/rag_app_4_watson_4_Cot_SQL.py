...
class CoTSmartRAGSystem:
    ...
    def __init__(self, papers_dir: str = "./papers/", enable_cot: bool = True):
        ...
        # 교통량 분석 템플릿 예시 SQL 쿼리 (동일한 수치, 다른 형태)
        # 테스트할 때는 원하는 템플릿만 주석 해제하여 사용
        self.predefined_queries = {
            # 템플릿 0 (문장 설명형) - 현재 활성화
            "7월 강남구 교통량은?": {
                "sql": """
                    SELECT 
                        '7월 강남구 교통량은 24,850건이고, 러시아워에서 제일 수요가 많았던 정류장은 강남역(4,620명)입니다. 시간대별 패턴은 아침 출근시간대(06:00-09:00)에 가장 높고, 저녁 퇴근시간대(18:00-21:00)에 두 번째 피크를 보이는 형태로 나타나고 있습니다.' as 분석결과
                """,
                "description": "7월 강남구 교통량 문장 분석 - 템플릿 0 (문장 설명형)"
            }
            ...
            #             '강남구' as 지역,
            #             24850 as 총_교통량,
            #             '06:00-09:00' as 러시아워_시간대,
            #             '강남역' as 최대수요_정류장,
            #             4620 as 최대수요_승객수,
            #             '아침 출근시간대(06:00-09:00)에 가장 높고, 저녁 퇴근시간대(18:00-21:00)에 두 번째 피크를 보임' as 시간대별_패턴
            #         """,
            #     "description": "7월 강남구 교통량 종합 분석 - 템플릿 1 (상세형)"
            # },
            ...
            #             '7월' as period,
            #             '강남구' as region,
            #             24850 as total_traffic,
            #             '강남역' as peak_station,
            #             4620 as peak_passengers,
            #             '오전 6-9시, 오후 6-9시에 집중' as time_pattern
            #         """,
            #     "description": "7월 강남구 교통현황 - 템플릿 2 (간소형)"
            # },
            ...
            #             SELECT 
            #                 '강남구' as region_name,
            #                 '7월' as analysis_month,
            #                 24850 as total_volume,
            #                 '06:00-09:00' as rush_hour_time,
            #                 '강남역' as max_demand_station,
            #                 4620 as max_demand_count,
            #                 '아침(06:00-09:00)에 가장 높고, 저녁(18:00-21:00)에 두 번째 피크를 보임' as hourly_pattern_summary
            #         ) as traffic_analysis
            #         """,
            #     "description": "7월 강남구 대중교통 이용현황 - 템플릿 3 (구조화형)"
            # },
            ...
            #     "sql": """
            #         SELECT 
            #             '강남구 7월 교통량: 24,850건' as summary,
            #             '강남역(4,620명)' as top_station,
            #             '러시아워(06:00-09:00, 18:00-21:00)에 집중' as peak_analysis,
            #             '아침 출근시간대에 가장 높고, 저녁 퇴근시간대에 두 번째 피크' as weekly_pattern
            #         """,
            #     "description": "7월 강남구 교통 통계 - 템플릿 4 (요약형)"
            # },
            ...
            #             time_distribution.*
            #         FROM (
            #             SELECT 24850 as monthly_traffic, '강남구' as region_name, 'active' as status
            #         ) as traffic_stats
            #         CROSS JOIN (
            #             SELECT '강남역' as rank_1_station, 4620 as rank_1_count,
            #                    '역삼역' as rank_2_station, 3200 as rank_2_count,
            #                    '선릉역' as rank_3_station, 2800 as rank_3_count
            #         ) as station_ranking
            #         CROSS JOIN (
            #             SELECT '06:00-09:00' as rush_hour_time,
            #                    '아침 출근시간대(06:00-09:00)에 가장 높고, 저녁 퇴근시간대(18:00-21:00)에 두 번째 피크를 보임' as hourly_breakdown
            #         ) as time_distribution
            #         """,
            #     "description": "7월 강남구 이동량 분석 - 템플릿 5 (다차원형)"
            # }
        }
