...
def main():
    ...
    try:
        ...
        print("\n환경 설정을 확인하세요:")
        print("1. Ollama 서비스 실행 여부")
        print("2. 필요한 모델 설치 여부")
        print("3. papers/ 폴더의 PDF 파일 존재 여부") 
        print("4. PostgreSQL 연결 설정")
