...
export const DemandContent = memo(function DemandContent({
  ...
  return (
    <div className="space-y-6">
      {/* 2x2 그리드 레이아웃 */}
      <div className="grid grid-cols-12 auto-rows-max gap-4 min-h-[1400px]">
        {/* 좌상: 지도 (9/12) - 2행 확장 */}
        <div className="col-span-9 row-span-2">
          <Card className="h-[1150px]">
            <CardHeader>
            ...
            <CardContent className="h-[950px] min-h-[950px] max-h-[950px] p-6">
              ...
              <div className="space-y-3">
                {drtData?.top_stations && drtData.top_stations.length > 0 ? (
                  drtData.top_stations
                    .slice(0, 5)
                    .map((station, index) => {
                      const isSelectedStation = selectedStation?.station_id === station.station_id;
                      return (
                      <div 
                        key={station.station_id} 
                        ...
                        <div className="flex items-start gap-2 mb-2">
                          <div className="flex-1 min-w-0">
                            <h4 className="font-semibold text-sm">
                              ...
                              {isSelectedStation && <span className="ml-1 text-blue-600">✓</span>}
                            </h4>
