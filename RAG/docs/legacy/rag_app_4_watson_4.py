...
def interactive_chat(rag_system: SmartRAGSystem):
    """대화형 채팅 인터페이스"""
    print("=" * 80)
    print("🤖 Watson AI 기반 스마트 DRT 분석 어시스턴트 (Few-shot 프롬프팅 버전)")
    print("=" * 80)
...
def main():
    ...
    try:
        ...
        print(f"🚀 Watson AI 기반 스마트 RAG 시스템 초기화 중 (Few-shot 프롬프팅 버전)...")
        print(f"📡 모델: {CHAT_MODEL}")
        print(f"🔗 임베딩: {EMBEDDING_MODEL}")
        print(f"🎯 특징: Few-shot 프롬프팅으로 일관되고 전문적인 DRT 답변 제공!")
