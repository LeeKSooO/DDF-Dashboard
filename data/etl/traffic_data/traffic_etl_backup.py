...
def main():
    ...
    # 한달 데이터 적재 (시계열 분석을 위해)
    logger.info("📊 Starting monthly data load for time-series analysis...")
    logger.info("📅 Date range: 2025-07-16 to 2025-08-15 (30 days)")
    etl.run_full_etl(start_date='20250716', end_date='20250815')
